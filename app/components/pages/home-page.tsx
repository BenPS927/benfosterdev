    ...
    <div className="mx-auto ml-2 mr-2 mt-4 bg-gray-20">
      ...
      <main className="flex flex-col lg:flex-row p-4 gap-4 rounded-b-md">
        <div className="p-4 flex-1 min-w-0">
          ...
          <div className="flex p-4 mt-28 gap-8 items-center">
            ...
            <div className="w-24 h-24 flex-shrink-0 rounded-full bg-white shadow-lg border-1 border-gray-200 flex items-center justify-center hover:scale-110 cursor-pointer transition">
            ...
            <div className="w-24 h-24 flex-shrink-0 rounded-full bg-white shadow-lg border-1 border-gray-200"></div>
           <div className="w-24 h-24 flex-shrink-0 rounded-full bg-white shadow-lg border-1 border-gray-200"></div>
          </div>
        </div>
