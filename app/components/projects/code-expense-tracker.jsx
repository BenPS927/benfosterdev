...
export function CodeExpenseTracker() {
            ...
            <AnimatePresence>
                {isMenuOpen && (
                    <motion.div 
                        ...
                        className="absolute top-18 right-3 lg:right-12 w-30 lg:w-60 space-y-2 lg:space-y-4">
                ...
                <div className="p-1 lg:p-2 space-y-2 lg:space-y-4">
                    <div className="p-1 lg:p-2 mx-auto w-fit space-y-2 lg:space-y-4 text-center">
                        ...
                        <button className="p-2 lg:p-4 rounded-lg text-purple-500 bg-white
                            hover:bg-yellow-50 hover:scale-110 cursor-pointer transition shadow-lg" 
                            onClick={() => setIsMenuOpen(!isMenuOpen)}>
                            {isMenuOpen === false && (<p>Add an item</p>)} 
                            {isMenuOpen && (<p>Close</p>)}
                        </button>
                    </div>
                    <div className="flex p-1 lg:p-2 gap-2 lg:gap-4">
                        <div className="p-1 lg:p-2 space-y-2 lg:space-y-4 w-1/2">
                            <div className="p-2 lg:p-4 font-sora text-lg lg:text-xl text-purple-700 rounded-lg shadow-lg bg-white">
                                Left to spend: {remaining}
                            </div>
                            <div className="p-2 lg:p-4 font-sora text-lg lg:text-xl text-purple-700 rounded-md shadow-lg bg-white">
