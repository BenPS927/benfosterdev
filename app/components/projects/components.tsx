...
export function ShopLink(){
    return(
        ...
        <Link href="/shop" className=" relative w-2/3 h-2/3 p-2 flex items-center justify-center rounded-md shadow-lg md:bg-orange-100 lg:bg-white cursor-pointer hover:scale-110 transition">
