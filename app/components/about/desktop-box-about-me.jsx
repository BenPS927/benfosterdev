...
export function AboutMeBoxDesktop (props) {
    ...
    return (
        <motion.div 
            ...
            className="mt-4 rounded-xl border border-neutral-900/10 bg-white p-6 text-gray-700 shadow-sm transition duration-200 hover:z-100 hover:-translate-y-0.5 hover:scale-[1.02] hover:shadow-md lg:p-7">
            {props.text}
            {props.images}
