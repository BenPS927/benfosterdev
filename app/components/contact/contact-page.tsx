                    ...
                    >
                        <div className="gap-8 lg:gap-128 flex flex-row">
                            <div className="justify-center">
                                <LinkedInIcon sx={{ fontSize: { xs: 60, lg: 120 }, color: '#0A66C2', '&:hover': { color: '#004182', transform: 'scale(1.1)' }, cursor: 'pointer', transition: 'color 0.7s, transform 0.4s' }} />
                            </div>
                            <div>
                                <GitHubIcon sx={{ fontSize: { xs: 60, lg: 120 }, color: '#181717', '&:hover': { color: '#e5e0ed', transform: 'scale(1.1)' }, cursor: 'pointer', transition: 'color 0.7s, transform 0.4s' }} />
                            </div>
                        </div>
                    </motion.div>
                </main>
