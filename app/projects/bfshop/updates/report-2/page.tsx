...
import BFShopProgressReport2 from '@/app/components/bfshop-documentation/bfshop-progress-report-2';
...
const schema = {
    ...
    description: 'Second BFshop delivery report covering backend cart-slice architecture and service-layer progress.',
    url: 'https://benfosterdev.com/projects/bfshop/updates/report-2',
    ...
    mainEntityOfPage: 'https://benfosterdev.com/projects/bfshop/updates/report-2',
    breadcrumb: {
        '@type': 'BreadcrumbList',
        itemListElement: [
            {
            ...
            },
            {
                ...
                item: 'https://benfosterdev.com/projects/bfshop/updates/report-2',
            },
        ],
    },
};
